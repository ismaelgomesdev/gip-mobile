...
import styles from './stock-selector.module.scss';
...
const StockSelector = ({ onSelectItem, selectedItems, onRemoveItem }) => {
  ...
  return (
    <div className={`${styles.stockSelector} mb-5`}>
      <div className="flex items-center mb-4">
        <label className="font-bold mr-4 text-gray-800">Selecionar Item do Estoque:</label>
        <select value={selectedStockItem} onChange={handleSelectChange} className="mr-4 p-2 rounded-md">
        ...
        <input 
          ...
          className="mr-4 p-2 rounded-md w-20"
        />
